...
export const blogPosts = await create.doc("blogPosts", "content/blog", {"better-auth.mdx": __fd_glob_0, "why-frontend-authentication-does-not-protect-your-database-nextjs-trpc.mdx": __fd_glob_1, });